...
<tr> 
  <td style="border-left:1px solid black;border-top:1px solid black;height:-15%;"><br>
  </td>
  ...
  <td><strong style="font-size:10px;">VIGNETTE TVA</strong><br>
...
<tr>
  ...
  <td style="border-right:1px solid black;border-bottom:1px solid black;height:-15%;"><br>
...
;
 ...
 <td style="border-top:1px solid black;border-bottom:1px solid black;text-align:right;"> <strong style="font-size:13px;"> AUTRES DEBOURS </strong></td>
 <td style="border:1px solid black;">  </td>
 <td style="border:1px solid black;"> </td>
 <td style="border:1px solid black;">  </td>
...
echo 
 ...
 <td style="text-align:right;"><strong style="font-size:13px;"> TOTAL  AUTRES DEBOURS </strong> <br>
 <strong style="font-size:13px;">TOTAL DEBOURS </strong></td>
 <td style="">  </td>
 <td style="">  </td>
 <td style="border-right:1px solid black;border-left:1px solid black;font-size:13px; text-align: center;"> '.$sommeautredebours.' '.($sommedebours2+$sommedebours1).' </td>
 ...
 <td style="text-align:right;border-top:1px solid black;"> <strong style="font-size:13px;"> HONORAIRES </strong></td>
...
;
 ...
 <td style="text-align:right;"></td>
 <td colspan="2" style="border-left:1px solid black;border-bottom:1px solid black;font-size:12px;"> <strong>RED. COMMERCIALE</strong> </td>
 <td style="border-right:1px solid black;border-left:1px solid black;border-bottom:1px solid black;font-size:13px; text-align: center;"> '.$info_facture->reduction.' </td>
 ...
 <td style="text-align:right;"></td>
 <td colspan="2" style="border-left:1px solid black;border-bottom:1px solid black;"><strong style="font-size:12px;">TVA SUR HONO.(18%) </strong> </td>
 <td style="border-right:1px solid black;border-left:1px solid black;border-bottom:1px solid black;font-size:13px; text-align: center;"> '.(($sommehonoraire*18)/100).'  </td>
 ...
 <td style="border-right:1px solid black;border-left:1px solid black;font-size:13px;border-bottom:1px solid black;background-color:#62bfe8; text-align: center;"> '.($montantnetht+(($sommehonoraire*18)/100)).' </td>
 ...
 <td colspan="4" style="border-bottom:1px solid black;border-right:1px solid black;background-color:#62bfe8"><strong style="font-size:13px;">Arrêté à la présente facture à la somme de '.$this->numbertowords->convert_number(($montantnetht+(($sommehonoraire*18)/100))).' </strong></td>
   ...
   <div style="font-size:12px;position:absolute;top:910px;"><strong style="text-decoration:underline;">NB: </strong><strong>Le paiement du montant TTC ci-dessus devra être fait après déduction de la retenue de 5% sur les honoraires HT soit <?php echo ($montantnetht+(($sommehonoraire*18)/100)); ?> FCFA</strong></div>

<div style="margin-left:400px;margin-bottom:15px;">&nbsp; </div>
<div style="font-size:12px;position:absolute;top:912px;">
  <div style="margin-left:490px; margin-top: 10px; margin-bottom:30px;"> 
      <strong style="font-size:10px;"> LE DIRECTEUR GENERAL DELEGUE</strong>
  </div>
  <div style="margin-left:490px; margin-top: 30px;"> 
      <strong style="font-size:10px;"> FRANK GBETUDOR</strong>
  </div>
  </div>
