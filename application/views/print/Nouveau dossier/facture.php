...
;
 ...
 <td colspan="4" style="border-bottom:1px solid black;border-right:1px solid black;background-color:#62bfe8"><strong style="font-size:13px;">Arrêté à la présente facture à la somme de '.$this->numbertowords->convert_number(($montantnetht+(($sommehonoraire*18)/100))).' </strong></td>
   ...
   <div style="font-size:12px;margin-top: 5px;"><strong style="text-decoration:underline;">NB: </strong><strong>Le paiement du montant TTC ci-dessus devra être fait après déduction de la retenue de 5% sur les honoraires HT soit <?php echo ($montantnetht+(($sommehonoraire*18)/100)); ?> FCFA</strong></div>
   </table>
